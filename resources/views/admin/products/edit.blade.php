                    ...
                    <div class="card p-3">
                        <form method="post" action="{{ route('admin.products.update', [$product]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" value="{{ old('title', $product->title) }}" id="title" placeholder="example: 5 tips travel">
                                </div>
                            </div>
                            {{-- <div class="form-group row border-bottom pb-4">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="excerpt" id="excerpt" cols="30" rows="5">{{ old('excerpt', $product->excerpt) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
